...
# Function to draw a moving line
...
line_x1, line_y1 = 0, 0  # Initial position of the line
line_x2, line_y2 = 128, 64  # Initial end of the line
text_flash = True  # Toggle flashing text
...
while True:
    ...
    # Move the line (diagonal movement)
    line_x1 += 1
    line_y1 += 1
    line_x2 -= 1
    line_y2 -= 1
    if line_x1 >= 128 or line_x2 <= 0:
        line_x1, line_y1 = 0, 0
        line_x2, line_y2 = 128, 64

    # Toggle flashing text visibility every 0.5 seconds
